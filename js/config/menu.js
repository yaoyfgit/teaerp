...
const menuConfig = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                title: '付款管理',
                icon: 'credit-card',
                path: 'C:/teaerp/pages/finance/payment/index.html'
            },
            {
                key: 'invoice',
                title: '发票管理',
                        ...
                        children: [
                            {
                                key: 'product-cost',
                                title: '产品成本分析',
                                path: 'C:/teaerp/pages/finance/cost/analysis/product.html'
                            },
                            {
                                key: 'department-cost',
                                title: '部门成本分析',
                                path: 'C:/teaerp/pages/finance/cost/analysis/department.html'
                            },
                            {
                                key: 'project-cost',
                                title: '项目成本分析',
                                path: 'C:/teaerp/pages/finance/cost/analysis/project.html'
                            }
                        ]
                    },
                    {
                        ...
                        title: '预算管理',
                        icon: 'balance-scale',
                        path: 'C:/teaerp/pages/finance/cost/budget/index.html'
                    },
                    {
                        key: 'cost-report',
                        title: '成本报表',
                        ...
                        children: [
                            {
                                key: 'cost-summary',
                                title: '成本汇总表',
                                path: 'C:/teaerp/pages/finance/cost/report/summary.html'
                            },
                            {
                                key: 'cost-variance',
                                title: '成本差异表',
                                path: 'C:/teaerp/pages/finance/cost/report/variance.html'
                            },
                            {
                                key: 'cost-trend',
                                title: '成本趋势表',
                                path: 'C:/teaerp/pages/finance/cost/report/trend.html'
                            }
                        ]
                    }
                ]
            ...
            },
            {
                ...
                path: 'C:/teaerp/pages/finance/warning/index.html'
            }
        ]
    },
    {
